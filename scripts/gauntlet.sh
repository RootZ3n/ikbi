...
run_scenario "R1-S5" "Godot validator task" "/lab-fake/gauntlet-godot" \
...
run_scenario "R2-S6" "No package manager (empty dir)" "/lab-fake/gauntlet-nopkg" \
  "Build a utility that does something useful in this repo."

run_scenario "R2-S7" "Empty repo with vague goal" "/lab-fake/gauntlet-empty" \
...
run_scenario "R2-S9" "Build --help" "/lab-fake/gauntlet-help" \
