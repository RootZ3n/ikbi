...
const cfg = (allowlist: string[]): GovernedExecConfig => ({ enabled: true, allowlist, execTimeoutMs: 1000, maxBuffer: 1_000_000, networkTimeoutMs: 1000, jobKillGraceMs: 5000, sandbox: { mode: "off", trustedLocalOverride: false } });
