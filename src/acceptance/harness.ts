...
export function realGovernedExec(allowlist: readonly string[]): GovernedExec {
  return createGovernedExec({
    config: { enabled: true, allowlist: [...allowlist], execTimeoutMs: 30_000, maxBuffer: 8_000_000, networkTimeoutMs: 5_000, jobKillGraceMs: 5_000, sandbox: { mode: "off", trustedLocalOverride: false } },
