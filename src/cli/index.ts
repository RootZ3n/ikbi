...
function printUsage(argv: readonly string[] = []): void {
  ...
  if (showAdvanced) {
    const lines = [
      ...
      "  run --spec <file>  External-agent task-file build (LEGACY v1 engine; `ikbi build` is canonical)",
    ...
    const lines = [
      ...
      "  ikbi run --spec <file>    External-agent task-file build (LEGACY v1 engine)",
